...
class TestTTSConverter:
    ...
    @patch('tts_converter.texttospeech.TextToSpeechClient')
    @patch('os.environ')
    def test_tts_initialization_with_credentials_path(self, mock_environ, mock_client_class):
    ...
    @patch('os.makedirs')
    def test_convert_text_to_speech_success(self, mock_makedirs, mock_file, mock_client_class):
    ...
    def test_convert_text_to_speech_api_error(self, mock_client_class):
        ...
        mock_client = Mock()
        mock_client.synthesize_speech.side_effect = gcloud_exceptions.GoogleAPIError("API Error")
        mock_client_class.return_value = mock_client
    ...
    def test_convert_text_to_speech_permission_error(self, mock_file, mock_client_class):
